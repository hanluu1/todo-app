...
import { ExclamationIcon, PencilAltIcon, TrashIcon, CheckIcon, XIcon, TagIcon, PlusCircleIcon, BackspaceIcon, PencilIcon } from "@heroicons/react/outline";
          ...
          >
            <div className="flex flex-col p-4">
              <div className="flex items-center justify-between w-full">
                ...
                <PlusCircleIcon className="flex-shrink-0 w-5 h-5 text-black cursor-pointer" onClick={() => {setShowForm(true)}}/>
